...
export const CONTRACTS: Record<string, string> = {
    ...
    presaleRedemption: "PresaleRedemption",
    bash: "BASHERC20Token",
    sBash: "sBASH",
...
export const INITIAL_DAI_RESERVES_AMOUNT = 3000;       // 3k DAI, not including the DAI needed for BASH mint
export const INITIAL_BASH_LIQUIDITY_IN_DAI = 3000;     // bash needed at deposit not including what's needed for LP
