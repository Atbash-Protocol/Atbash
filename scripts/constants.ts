...
export const EPOCH_LENGTH_IN_IN_SECONDS = 28800; // 60 * 10; // 28800 = 8 hours
export const FIRST_EPOCH_NUMBER = "0";
export const FIRST_EPOCH_TIME = parseInt(JSON.stringify(date / 1000) + EPOCH_LENGTH_IN_IN_SECONDS); // in seconds - ohmv2: // export const FIRST_EPOCH_TIME = "1639430907";
...
export const NEXT_EPOCH_TIME =  parseInt( JSON.stringify((date / 1000) + EPOCH_LENGTH_IN_IN_SECONDS));
export const STAKING_REWARD_RATE = "5000";

export const ZERO_ADDRESS = "0x0000000000000000000000000000000000000000";

// todo: delete export const BASHDAI_LP_TOKEN_ADDRESS = process.env.BASHDAI_LP_TOKEN_ADDRESS !== undefined ? process.env.BASHDAI_LP_TOKEN_ADDRESS : "";
